...
<head>
    ...
    <!-- CSRF Security Token for Axios & AJAX requests -->
...
<body class="font-sans antialiased text-slate-800 bg-white selection:bg-emerald-600 selection:text-white min-h-screen">
    @inertia
