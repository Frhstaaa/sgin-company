 ...
 *
 * Catatan Keamanan:
 * Anda bisa mengubah $secretToken di bawah ini sesuai keinginan.
 */
...
// 3. Tambahkan environment PATH agar shell_exec dapat menemukan git, php, composer, npm di Linux
...
// Buffer output agar log langsung tampil di browser
...
<div class="container">
    ...
    <p style="color: #8b949e; font-size: 13px; margin-bottom: 20px;">
        Waktu Eksekusi: <?= date('Y-m-d H:i:s') ?> | Server User: <?= htmlspecialchars(get_current_user() ?: 'web-service') ?>
    </p>

    <?php
    // 4. Hapus public/hot untuk mencegah masalah CORS / dev server Vite
    $hotFile = __DIR__ . '/hot';
    ...
    // 5. Masuk ke root direktori proyek Laravel
    $basePath = dirname(__DIR__);
    chdir($basePath);

    // 6. Daftar Perintah Pembaruan
    $commands = [
        '1. Konfigurasi Git Safe Directory' => 'git config --global --add safe.directory ' . escapeshellarg($basePath),
        '2. Git Pull (Ambil Kode Terbaru)' => 'git pull origin main',
        '3. Bersihkan Cache Laravel' => 'php artisan optimize:clear',
        '4. Hubungkan Storage Link' => 'php artisan storage:link',
        '5. Jalankan Migrasi Database' => 'php artisan migrate --force',
        '6. Optimasi Cache Produksi' => 'php artisan optimize',
    ];

    // 7. Eksekusi Setiap Perintah
    ...
    <div class="success-box">
        ...
        <p style="margin: 0 0 12px 0; color: #c9d1d9; font-size: 14px;">Semua kodingan terbaru dari branch <code>main</code> telah sinkron ke CyberPanel.</p>
